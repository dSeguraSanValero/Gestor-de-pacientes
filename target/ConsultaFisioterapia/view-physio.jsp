...
<body>
    <header data-bs-theme="dark">
      ...
      <% for (Tratamiento tratamiento : tratamientos) { %>
        <p> El día: <b><%= tratamiento.getFechaTratamiento() %></b>, se trató al paciente con el identificador: <b><%= tratamiento.getId_paciente() %></b> por el motivo: <b><%= tratamiento.getMotivo() %></b></p>
      <% } %>
