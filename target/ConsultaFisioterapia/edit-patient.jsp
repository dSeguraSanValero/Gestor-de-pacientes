...
<body>
    ...
    <form action="edit-paciente" method="post">
        ...
        <label for="nuevoApellido">Nuevo Apellido del paciente:</label>
        <input type="text" id="nuevoApellido" name="nuevoApellido"><br>
        <label for="nuevoTelefono">Introduzca el nuevo número de telefono del paciente:</label>
        <input type="text" id="nuevoTelefono" name="nuevoTelefono"><br>
        <label for="nuevaFechaNacimiento">Introduzca la nueva fecha de nacimiento:</label>
        <input type="date" id="nuevaFechaNacimiento" name="nuevaFechaNacimiento"><br>
